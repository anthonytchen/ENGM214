...
\title{\vspace{-2cm} Lecture 9 -- Introduction to empirical models}
...
\section{Typical empirical models}

\section{Issues with empirical models}

\section{Empirical modelling examples}

\begin{exmp}[Developing an empirical model for partition coefficient]

Partition coefficient between lipid and water.

\end{exmp}


\begin{exmp}[Developing an empirical model for predicting furnace efficiency]
...
\begin{exmp}[Developing an empirical model for xxx]

A dynamic ARX type of model
